...
class ElisaLogbook:
    ...
    def message_on_start(self, message:str, run_num:int, run_type:str):
        ...
        text = f"<p>User {credentials.user} started run {self.current_run_num} of type {self.current_run_type}</p>"
        if message != "":
            text += "\n<p>"+credentials.user+": "+message+"</p>"
        text += "\n<p>log automatically generated by NanoRC.</p>"
        
        title = f"{credentials.user} started new run {self.current_run_num} ({self.current_run_type})"
    ...
    def message_on_stop(self, message:str):
        text = f"<p>User {credentials.user} finished run {self.current_run_num}</p>"
        if message!="":
            text = "\n<p>"+credentials.user+": "+message+"</p>"
        text += "\n<p>log automatically generated by NanoRC.</p>"
        
        title = f"{credentials.user} ended run {self.current_run_num} ({self.current_run_type})"
